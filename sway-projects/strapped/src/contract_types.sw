...
impl Strap {
    pub fn into_sub_id(self) -> SubId {
        ...
        sub_id[1] = match self.kind {
            ...
            StrapKind::Bracelet => 10_u8,
            StrapKind::Tattoo => 11_u8,
            StrapKind::Skirt => 12_u8,
            StrapKind::Piercing => 13_u8,
            StrapKind::Coat => 14_u8,
            StrapKind::Scarf => 15_u8,
            StrapKind::Gloves => 16_u8,
            StrapKind::Gown => 17_u8,
            StrapKind::Belt => 18_u8,
        };
