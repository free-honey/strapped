...
import type { Provider, CoinQuantity, Account, TransferParams, TransactionCost, AssembleTxParams, ShouldConsolidateCoinsParams } from '@fuel-ts/account';
import { ScriptTransactionRequest } from '@fuel-ts/account';
import type { ContractCall, InvocationScopeLike, TxParams, FunctionResult, DryRunResult, AbstractContract, AbstractProgram, PreConfirmationFunctionResult } from '../types';
/**
...
export declare class BaseInvocationScope<TReturn = any> {
     ...
     */
    fundWithRequiredCoins({ skipAutoConsolidation, }?: ShouldConsolidateCoinsParams): Promise<ScriptTransactionRequest>;
    /**
     * @deprecated - Should be removed with `addSigners`
     */
    private legacyFundWithRequiredCoins;
    /**
     ...
     * @returns The current instance of the class.
     */
    assembleTxParams(txParams: Partial<Omit<AssembleTxParams, 'request'>>): this;
    /**
     ...
     * @returns The current instance of the class.
     */
    addContracts(contracts: Array<AbstractContract | string>): this;
    /**
     ...
     * @returns The current instance of the class.
     */
    fromRequest(request: ScriptTransactionRequest): this;
    /**
