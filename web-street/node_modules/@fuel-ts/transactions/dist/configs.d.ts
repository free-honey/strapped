...
export declare const REVERT_WITH_LOG_SIGNAL = "0xffffffffffff0006";
...
export declare const SwaySignalErrors: {
    FAILED_REQUIRE_SIGNAL: string;
    FAILED_TRANSFER_TO_ADDRESS_SIGNAL: string;
    FAILED_ASSERT_EQ_SIGNAL: string;
    FAILED_ASSERT_SIGNAL: string;
    FAILED_ASSERT_NE_SIGNAL: string;
    REVERT_WITH_LOG_SIGNAL: string;
};
