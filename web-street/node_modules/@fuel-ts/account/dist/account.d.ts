...
export declare class Account extends AbstractAccount implements WithAddress {
     ...
     */
    getResourcesToSpend(quantities: CoinQuantityLike[], resourcesIdsToIgnore?: ResourcesIdsToIgnore, { skipAutoConsolidation }?: ShouldConsolidateCoinsParams): Promise<Resource[]>;
    /**
     ...
     */
    fund<T extends TransactionRequest>(request: T, params: EstimatedTxParams, { skipAutoConsolidation }?: ShouldConsolidateCoinsParams): Promise<T>;
    /**
     ...
     */
    createTransfer(destination: string | Address, amount: BigNumberish, assetId?: BytesLike, txParams?: TxParamsType, { skipAutoConsolidation }?: ShouldConsolidateCoinsParams): Promise<ScriptTransactionRequest>;
    /**
     ...
     */
    transfer(destination: string | Address, amount: BigNumberish, assetId?: BytesLike, txParams?: TxParamsType, { skipAutoConsolidation }?: ShouldConsolidateCoinsParams): Promise<TransactionResponse>;
    /**
     ...
     */
    batchTransfer(transferParams: TransferParams[], txParams?: TxParamsType, { skipAutoConsolidation }?: ShouldConsolidateCoinsParams): Promise<TransactionResponse>;
    /**
     ...
     * @returns A promise that resolves to the transaction response.
     */
    transferToContract(contractId: string | Address, amount: BigNumberish, assetId: BytesLike, txParams?: TxParamsType, { skipAutoConsolidation }?: ShouldConsolidateCoinsParams): Promise<TransactionResponse>;
    batchTransferToContracts(contractTransferParams: ContractTransferParams[], txParams?: TxParamsType, { skipAutoConsolidation }?: ShouldConsolidateCoinsParams): Promise<TransactionResponse>;
    /**
     ...
     * @returns A promise that resolves to the transaction response.
     */
    withdrawToBaseLayer(recipient: AddressInput, amount: BigNumberish, txParams?: TxParamsType, { skipAutoConsolidation }?: ShouldConsolidateCoinsParams): Promise<TransactionResponse>;
    /**
     ...
     */
    startConsolidation(opts: StartConsolidateCoins): Promise<boolean>;
    /**
     ...
     */
    assembleBaseAssetConsolidationTxs(params: Omit<AssembleConsolidationTxsParams, 'assetId'>): Promise<{
        txs: ScriptTransactionRequest[];
        totalFeeCost: BN;
        submitAll: SubmitAllCallback;
    }>;
    assembleNonBaseAssetConsolidationTxs(params: AssembleConsolidationTxsParams & {
        assetId: string;
    }): Promise<{
        txs: ScriptTransactionRequest[];
        totalFeeCost: BN;
