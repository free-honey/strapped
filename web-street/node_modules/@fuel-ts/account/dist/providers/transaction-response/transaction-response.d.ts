...
export declare class TransactionResponse {
     ...
     */
    constructor(transactionRequestOrId: string | TransactionRequest, provider: Provider, chainId: number, abis?: JsonAbisFromAllCalls, submitAndAwaitSubscription?: SubmitAndAwaitStatusSubscriptionIterable);
    /**
     * Creates a new TransactionResponse instance.
     *
