...
export declare class ScriptTransactionRequest extends BaseTransactionRequest {
     ...
     */
    estimateAndFund(account: Account, { signatureCallback, quantities, skipAutoConsolidation, }?: TransactionCostParams & ShouldConsolidateCoinsParams): Promise<ScriptTransactionRequest>;
    /**
     ...
     */
    addVariableOutput(to?: BytesLike, amount?: BigNumberish, assetId?: BytesLike): void;
    /**
