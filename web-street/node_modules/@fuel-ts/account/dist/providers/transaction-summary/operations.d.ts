...
/** @hidden */
export declare function getContractCallOperations({ inputs, outputs, receipts, abiMap, rawPayload, baseAssetId, }: InputOutputParam & ReceiptParam & Pick<GetOperationParams, 'abiMap' | 'maxInputs' | 'baseAssetId'> & RawPayloadParam): Operation[];
/** @hidden */
