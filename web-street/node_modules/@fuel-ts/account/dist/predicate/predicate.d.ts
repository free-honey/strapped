...
type IsNonEmptyTuple<T extends unknown[]> = number extends T['length'] ? false : T['length'] extends 0 ? false : true;
export type PredicateDataParam<TData extends InputValue[]> = IsNonEmptyTuple<TData> extends true ? {
    data: TData;
} : {
    data?: TData;
};
...
export declare class Predicate<TData extends InputValue[] = InputValue[], TConfigurables extends {
     ...
     */
    toNewInstance(overrides?: Partial<Pick<PredicateParams<TData, TConfigurables>, 'data' | 'configurableConstants'>>): Predicate<TData, TConfigurables>;
    /**
