...
function resolveDirective(part, value, parent2 = part, attributeIndex) {
  ...
  let currentDirective = attributeIndex !== void 0 ? (_a5 = parent2.__directives) == null ? void 0 : _a5[attributeIndex] : parent2.__directive;
...
var OptionsController = {
  ...
  setDisableAppend(disableAppend) {
    state2.disableAppend = disableAppend;
  },
  getSnapshot() {
...
if (typeof window !== "undefined") {
  ...
  if (!((_a4 = window.process) == null ? void 0 : _a4.env)) {
    window.process = { env: {} };
  }
}
  ...
  if (check)
    return ZodAny.create().superRefine((data, ctx) => {
      ...
      if (!check(data)) {
        ...
        const _fatal = (_b3 = (_a5 = p2.fatal) !== null && _a5 !== void 0 ? _a5 : fatal) !== null && _b3 !== void 0 ? _b3 : true;
...
var W3mFrameHelpers = {
  ...
  getRequestMethod(request) {
    var _a5;
    return (_a5 = request == null ? void 0 : request.payload) == null ? void 0 : _a5.method;
  },
    ...
    try {
      ...
      if (authConnector) {
        ...
        authConnector.provider.syncTheme({
          ...
          w3mThemeVariables: getW3mThemeVariables(state6.themeVariables, state6.themeMode)
        });
      }
    } catch {
      console.info("Unable to sync theme to auth connector");
...
var ConnectorController = {
  ...
  getAuthConnector() {
    return state7.connectors.find((c) => c.type === "AUTH");
  },
...
var NetworkController = {
  ...
  setSmartAccountEnabledNetworks(smartAccountEnabledNetworks) {
    state9.smartAccountEnabledNetworks = smartAccountEnabledNetworks;
  },
  ...
  checkIfSmartAccountEnabled() {
    var _a5, _b3;
    const networkId = NetworkUtil.caipNetworkIdToNumber((_a5 = state9.caipNetwork) == null ? void 0 : _a5.id);
    if (!networkId) {
      return false;
    }
    return Boolean((_b3 = state9.smartAccountEnabledNetworks) == null ? void 0 : _b3.includes(networkId));
  },
  resetNetwork() {
    ...
    state9.smartAccountEnabledNetworks = [];
  },
...
var ConnectionController = {
  ...
  connectWalletConnect() {
    state10.wcPromise = this._getClient().connectWalletConnect((uri) => {
      state10.wcUri = uri;
  ...
  async setPreferredAccountType(accountType) {
    ...
    EventsController.sendEvent({
      ...
      properties: { accountType, network: ((_a5 = NetworkController.state.caipNetwork) == null ? void 0 : _a5.id) || "" }
    });
  },
...
var state12 = proxy(initialState);
var SwapController = {
  state: state12,
  subscribe(callback) {
  ...
  getParams() {
    ...
    const invalidToToken = !((_b3 = state12.toToken) == null ? void 0 : _b3.address) || !((_c = state12.toToken) == null ? void 0 : _c.decimals);
    const invalidSourceToken = !((_d = state12.sourceToken) == null ? void 0 : _d.address) || !((_e = state12.sourceToken) == null ? void 0 : _e.decimals) || !NumberUtil.bigNumber(state12.sourceTokenAmount).isGreaterThan(0);
    const invalidSourceTokenAmount = !state12.sourceTokenAmount;
    return {
      networkAddress,
      fromAddress: address,
      fromCaipAddress: AccountController.state.caipAddress,
      sourceTokenAddress: (_f = state12.sourceToken) == null ? void 0 : _f.address,
      toTokenAddress: (_g = state12.toToken) == null ? void 0 : _g.address,
      toTokenAmount: state12.toTokenAmount,
      toTokenDecimals: (_h = state12.toToken) == null ? void 0 : _h.decimals,
      sourceTokenAmount: state12.sourceTokenAmount,
      sourceTokenDecimals: (_i = state12.sourceToken) == null ? void 0 : _i.decimals,
      invalidToToken,
      invalidSourceToken,
  ...
  setSourceToken(sourceToken) {
    if (!sourceToken) {
      state12.sourceToken = sourceToken;
      state12.sourceTokenAmount = "";
      state12.sourceTokenPriceInUSD = 0;
      return;
    }
    state12.sourceToken = sourceToken;
  ...
  setSourceTokenAmount(amount) {
    state12.sourceTokenAmount = amount;
  },
  setToToken(toToken) {
    if (!toToken) {
      state12.toToken = toToken;
      state12.toTokenAmount = "";
      state12.toTokenPriceInUSD = 0;
      return;
    }
    state12.toToken = toToken;
  ...
  setToTokenAmount(amount) {
    state12.toTokenAmount = amount ? NumberUtil.formatNumberToLocalString(amount, TO_AMOUNT_DECIMALS) : "";
  },
  async setTokenPrice(address, target) {
    const { availableToSwap } = this.getParams();
    let price = state12.tokensPriceMap[address] || 0;
    if (!price) {
      state12.loadingPrices = true;
      price = await this.getAddressPrice(address);
    }
    if (target === "sourceToken") {
      state12.sourceTokenPriceInUSD = price;
    } else if (target === "toToken") {
      state12.toTokenPriceInUSD = price;
    }
    if (state12.loadingPrices) {
      state12.loadingPrices = false;
      if (availableToSwap) {
        this.swapTokens();
      }
    }
  ...
  switchTokens() {
    if (state12.initializing || !state12.initialized) {
      return;
    }
    const newSourceToken = state12.toToken ? { ...state12.toToken } : void 0;
    const newToToken = state12.sourceToken ? { ...state12.sourceToken } : void 0;
    const newSourceTokenAmount = newSourceToken && state12.toTokenAmount === "" ? "1" : state12.toTokenAmount;
  ...
  resetState() {
    state12.myTokensWithBalance = initialState.myTokensWithBalance;
    state12.tokensPriceMap = initialState.tokensPriceMap;
    state12.initialized = initialState.initialized;
    state12.sourceToken = initialState.sourceToken;
    state12.sourceTokenAmount = initialState.sourceTokenAmount;
    state12.sourceTokenPriceInUSD = initialState.sourceTokenPriceInUSD;
    state12.toToken = initialState.toToken;
    state12.toTokenAmount = initialState.toTokenAmount;
    state12.toTokenPriceInUSD = initialState.toTokenPriceInUSD;
    state12.networkPrice = initialState.networkPrice;
    state12.networkTokenSymbol = initialState.networkTokenSymbol;
    state12.networkBalanceInUSD = initialState.networkBalanceInUSD;
    state12.inputError = initialState.inputError;
  },
  resetValues() {
    var _a5;
    const { networkAddress } = this.getParams();
    const networkToken = (_a5 = state12.tokens) == null ? void 0 : _a5.find((token) => token.address === networkAddress);
    this.setSourceToken(networkToken);
    this.setToToken(void 0);
  },
  getApprovalLoadingState() {
    return state12.loadingApprovalTransaction;
  },
  clearError() {
    state12.transactionError = void 0;
  },
  async initializeState() {
    if (state12.initializing) {
      return;
    }
    state12.initializing = true;
    if (!state12.initialized) {
      try {
        await this.fetchTokens();
        state12.initialized = true;
      } catch (error) {
        state12.initialized = false;
        SnackController.showError("Failed to initialize swap");
        RouterController.goBack();
      }
    }
    state12.initializing = false;
  },
  async fetchTokens() {
    var _a5;
    const { networkAddress } = this.getParams();
    ...
    const networkToken = (_a5 = state12.tokens) == null ? void 0 : _a5.find((token) => token.address === networkAddress);
    if (networkToken) {
      state12.networkTokenSymbol = networkToken.symbol;
      this.setSourceToken(networkToken);
  ...
  async getTokenList() {
    ...
    state12.tokens = tokens;
    state12.popularTokens = tokens.sort((aTokenInfo, bTokenInfo) => {
    ...
    state12.suggestedTokens = tokens.filter((token) => {
  ...
  async getAddressPrice(address) {
    var _a5, _b3;
    const existPrice = state12.tokensPriceMap[address];
    if (existPrice) {
      return existPrice;
    }
    ...
    const allTokens = [...state12.tokens || [], ...state12.myTokensWithBalance || []];
    ...
    state12.tokensPriceMap[address] = priceAsFloat;
    return priceAsFloat;
  },
  async getNetworkTokenPrice() {
    ...
    state12.tokensPriceMap[networkAddress] = parseFloat(price);
    state12.networkTokenSymbol = (token == null ? void 0 : token.symbol) || "";
    state12.networkPrice = price;
  },
  async getMyTokensWithBalance(forceUpdate) {
  ...
  setBalances(balances) {
    ...
    balances.forEach((token) => {
      state12.tokensPriceMap[token.address] = token.price || 0;
    });
    state12.myTokensWithBalance = balances.filter((token) => token.address.startsWith(caipNetwork.id));
    state12.networkBalanceInUSD = networkToken ? NumberUtil.multiply(networkToken.quantity.numeric, networkToken.price).toString() : "0";
  },
  async getInitialGasPrice() {
    ...
    const gasPrice = SwapCalculationUtil.getGasPriceInUSD(state12.networkPrice, gasLimit, gasFee);
    state12.gasFee = value;
    state12.gasPriceInUSD = gasPrice;
    return { gasPrice: gasFee, gasPriceInUSD: state12.gasPriceInUSD };
  },
  async swapTokens() {
    var _a5, _b3;
    const address = AccountController.state.address;
    const sourceToken = state12.sourceToken;
    const toToken = state12.toToken;
    const haveSourceTokenAmount = NumberUtil.bigNumber(state12.sourceTokenAmount).isGreaterThan(0);
    if (!toToken || !sourceToken || state12.loadingPrices || !haveSourceTokenAmount) {
      return;
    }
    state12.loadingQuote = true;
    const amountDecimal = NumberUtil.bigNumber(state12.sourceTokenAmount).multipliedBy(10 ** sourceToken.decimals);
    const quoteResponse = await BlockchainApiController.fetchSwapQuote({
      userAddress: address,
      projectId: OptionsController.state.projectId,
      from: sourceToken.address,
      to: toToken.address,
      gasPrice: state12.gasFee,
      amount: amountDecimal.toString()
    });
    state12.loadingQuote = false;
    ...
    const isInsufficientToken = this.hasInsufficientToken(state12.sourceTokenAmount, sourceToken.address);
    if (isInsufficientToken) {
      state12.inputError = "Insufficient balance";
    } else {
      state12.inputError = void 0;
  ...
  async getTransaction() {
    ...
    const sourceToken = state12.sourceToken;
    const toToken = state12.toToken;
    if (!fromCaipAddress || !availableToSwap || !sourceToken || !toToken || state12.loadingQuote) {
      return void 0;
    }
    try {
      state12.loadingBuildTransaction = true;
      ...
      state12.loadingBuildTransaction = false;
      state12.fetchError = false;
      return transaction;
    } catch (error) {
      RouterController.goBack();
      SnackController.showError("Failed to check allowance");
      state12.loadingBuildTransaction = false;
      state12.approvalTransaction = void 0;
      state12.swapTransaction = void 0;
      state12.fetchError = true;
      return void 0;
    }
  },
  async createAllowanceTransaction() {
    ...
    try {
      ...
      const transaction = {
        ...
        toAmount: state12.toTokenAmount
      };
      state12.swapTransaction = void 0;
      state12.approvalTransaction = transaction;
      return transaction;
    } catch (error) {
      RouterController.goBack();
  ...
  async createSwapTransaction() {
    ...
    try {
      ...
      state12.gasPriceInUSD = SwapCalculationUtil.getGasPriceInUSD(state12.networkPrice, gas, gasPrice);
      state12.approvalTransaction = void 0;
      state12.swapTransaction = transaction;
      return transaction;
    } catch (error) {
      RouterController.goBack();
  ...
  async sendTransactionForApproval(data) {
    ...
    state12.loadingApprovalTransaction = true;
    ...
    try {
      ...
      state12.approvalTransaction = void 0;
      state12.loadingApprovalTransaction = false;
    } catch (err) {
      const error = err;
      state12.transactionError = error == null ? void 0 : error.shortMessage;
      state12.loadingTransaction = false;
    }
  },
  async sendTransactionForSwap(data) {
    var _a5, _b3, _c, _d, _e, _f, _g, _h, _i, _j, _k, _l;
    if (!data) {
      return void 0;
    }
    const { fromAddress, toTokenAmount } = this.getParams();
    state12.loadingTransaction = true;
    const snackbarPendingMessage = `Swapping ${(_a5 = state12.sourceToken) == null ? void 0 : _a5.symbol} to ${NumberUtil.formatNumberToLocalString(toTokenAmount, 3)} ${(_b3 = state12.toToken) == null ? void 0 : _b3.symbol}`;
    const snackbarSuccessMessage = `Swapped ${(_c = state12.sourceToken) == null ? void 0 : _c.symbol} to ${NumberUtil.formatNumberToLocalString(toTokenAmount, 3)} ${(_d = state12.toToken) == null ? void 0 : _d.symbol}`;
    RouterController.pushTransactionStack({
      view: "Account",
      goBack: false,
      onSuccess() {
    ...
    try {
      const forceUpdateAddresses = [(_e = state12.sourceToken) == null ? void 0 : _e.address, (_f = state12.toToken) == null ? void 0 : _f.address].join(",");
  ...
  hasInsufficientToken(sourceTokenAmount, sourceTokenAddress) {
    const isInsufficientSourceTokenForSwap = SwapCalculationUtil.isInsufficientSourceTokenForSwap(sourceTokenAmount, sourceTokenAddress, state12.myTokensWithBalance);
    const insufficientNetworkTokenForGas = SwapCalculationUtil.isInsufficientNetworkTokenForGas(state12.networkBalanceInUSD, state12.gasPriceInUSD);
  ...
  setTransactionDetails() {
    ...
    state12.gasPriceInUSD = SwapCalculationUtil.getGasPriceInUSD(state12.networkPrice, BigInt(state12.gasFee), BigInt(INITIAL_GAS_LIMIT));
    state12.priceImpact = SwapCalculationUtil.getPriceImpact({
      sourceTokenAmount: state12.sourceTokenAmount,
      sourceTokenPriceInUSD: state12.sourceTokenPriceInUSD,
      toTokenPriceInUSD: state12.toTokenPriceInUSD,
      toTokenAmount: state12.toTokenAmount
    });
    state12.maxSlippage = SwapCalculationUtil.getMaxSlippage(state12.slippage, state12.toTokenAmount);
    state12.providerFee = SwapCalculationUtil.getProviderFee(state12.sourceTokenAmount);
  }
};
...
var AccountController = {
  ...
  setIsConnected(isConnected) {
    state13.isConnected = isConnected;
  },
  setCaipAddress(caipAddress) {
    state13.caipAddress = caipAddress;
    state13.address = caipAddress ? CoreHelperUtil.getPlainAddress(caipAddress) : void 0;
  },
  setBalance(balance, balanceSymbol) {
    state13.balance = balance;
    state13.balanceSymbol = balanceSymbol;
  },
  setProfileName(profileName) {
    state13.profileName = profileName;
  },
  setProfileImage(profileImage) {
    state13.profileImage = profileImage;
  },
  setAddressExplorerUrl(explorerUrl) {
    state13.addressExplorerUrl = explorerUrl;
  },
  setSmartAccountDeployed(isDeployed) {
    state13.smartAccountDeployed = isDeployed;
  },
  setCurrentTab(currentTab) {
    state13.currentTab = currentTab;
  },
  setTokenBalance(tokenBalance) {
    if (tokenBalance) {
      state13.tokenBalance = ref(tokenBalance);
    }
  },
  setConnectedWalletInfo(connectedWalletInfo) {
    state13.connectedWalletInfo = connectedWalletInfo;
  },
  setPreferredAccountType(preferredAccountType) {
    state13.preferredAccountType = preferredAccountType;
  },
  setSocialProvider(socialProvider) {
    if (socialProvider) {
      state13.socialProvider = socialProvider;
    }
  },
  setSocialWindow(socialWindow) {
    if (socialWindow) {
      state13.socialWindow = ref(socialWindow);
    }
  },
  async fetchTokenBalance() {
    ...
    try {
      if (state13.address && chainId) {
        const response = await BlockchainApiController.getBalance(state13.address, chainId);
  ...
  resetAccount() {
    state13.isConnected = false;
    state13.smartAccountDeployed = false;
    state13.currentTab = 0;
    state13.caipAddress = void 0;
    state13.address = void 0;
    state13.balance = void 0;
    state13.balanceSymbol = void 0;
    state13.profileName = void 0;
    state13.profileImage = void 0;
    state13.addressExplorerUrl = void 0;
    state13.tokenBalance = [];
    state13.connectedWalletInfo = void 0;
    state13.preferredAccountType = void 0;
    state13.socialProvider = void 0;
    state13.socialWindow = void 0;
  }
};
...
var AssetController = {
  ...
  subscribeNetworkImages(callback) {
    return subscribe(state14.networkImages, () => callback(state14.networkImages));
  },
  subscribeKey(key, callback) {
  ...
  setWalletImage(key, value) {
    state14.walletImages[key] = value;
  },
  setNetworkImage(key, value) {
    state14.networkImages[key] = value;
  },
  setConnectorImage(key, value) {
    state14.connectorImages[key] = value;
  },
  setTokenImage(key, value) {
    state14.tokenImages[key] = value;
  },
  setCurrencyImage(key, value) {
    state14.currencyImages[key] = value;
  }
};
...
var ApiController = {
  ...
  async fetchWallets({ page }) {
    ...
    state15.wallets = CoreHelperUtil.uniqueBy([...state15.wallets, ...data], "id");
  ...
  async sendNativeToken(params) {
    ...
    try {
      ...
      EventsController.sendEvent({
        ...
        properties: {
          isSmartAccount: AccountController.state.preferredAccountType === W3mFrameRpcConstants.ACCOUNT_TYPES.SMART_ACCOUNT,
          token: ((_a5 = this.state.token) == null ? void 0 : _a5.symbol) || "",
...
lit-html/development/directives/ref.js:
   ...
   *)
*/
//# sourceMappingURL=chunk-77VUN37T.js.map
